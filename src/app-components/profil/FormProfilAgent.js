...
import { updateAgentProfil } from "../../actions/user";
...
const formikEnhancer = withFormik({
  ...
  handleSubmit: (values, { props, setSubmitting }) => {
    ...
    props.updateAgentProfil(props.user.id, payload, setSubmitting, showAlert);
  },
  displayName: "MyForm",
});
...
const MyEnhancedForm = connect(mapStateToProps, { updateAgentProfil })(
  formikEnhancer(MyForm)
);

const FormProfilAgent = () => <MyEnhancedForm />;

export default FormProfilAgent;
