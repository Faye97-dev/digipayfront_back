...
import { updateResponsableProfil } from "../../actions/user";
...
const MyEnhancedForm = connect(mapStateToProps, { updateResponsableProfil })(
  formikEnhancer(MyForm)
);

const FormProfilResponsable = () => <MyEnhancedForm />;

export default FormProfilResponsable;
