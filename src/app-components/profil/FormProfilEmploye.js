...
import { updateEmployeProfil } from "../../actions/user";
...
const formikEnhancer = withFormik({
  ...
  handleSubmit: (values, { props, setSubmitting }) => {
    ...
    props.updateEmployeProfil(props.user.id, payload, setSubmitting, showAlert);
  },
  displayName: "MyForm",
});
...
const MyEnhancedForm = connect(mapStateToProps, { updateEmployeProfil })(
  formikEnhancer(MyForm)
);

const FormProfilEmploye = () => <MyEnhancedForm />;

export default FormProfilEmploye;
