...
import TransactionsFacturier from "./TransactionsFacturier";

class DashboardFacturier extends Component {
  render() {
    return (
      <>
...
export default connect(mapStateToProps, {})(DashboardFacturier);
