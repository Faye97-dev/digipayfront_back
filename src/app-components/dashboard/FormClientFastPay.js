...
import { addFastPayement_clientDigipay } from "../../actions/transaction";
...
const formikEnhancer = withFormik({
  ...
  handleSubmit: (values, { props, setSubmitting, resetForm }) => {
    ...
    //console.log(payload);
    props.addFastPayement_clientDigipay(
      payload,
      showAlert,
      setSubmitting,
      props.closeModal
...
const FormClientFastPay = (props) => <MyEnhancedForm {...props} />;
...
export default connect(mapStateToProps, { addFastPayement_clientDigipay })(
  FormClientFastPay
);
